/**
 * Minimal, dependency-free PNG encoder — just enough to embed a full-page
 * raster image in a fixture PDF (8-bit RGB, filter type 0, one IDAT chunk).
 * Used only to build the "scanned" test fixture; never shipped at runtime.
 */
